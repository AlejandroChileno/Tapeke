...
import { SIcon, SImage, SLoad, SNavigation, SPage, SPopup, STable2, SText, SView, SDate, SButtom } from 'servisofts-component';
...
class listaHorario extends Component {
    constructor(props) {
        ...
        this.key = "9b8f27e9-696d-446f-ae9b-5d6d5bf1ab24";
        ...
        return <STable2
            header={[
                ...
                },
                {
                    ...
                    component: (item) => {
                        return <SView onPress={() => { SNavigation.navigate("admin/horario/registro", { key: item, key_restaurante: this.key }) }}>
    ...
    render() {
        return (
            <SPage title={'Lista horario'} disableScroll>
                ...
                <SView col={"xs-4"} center height backgroundColor={"red"}>Hola</SView>
                <FloatButtom fontSize={20} onPress={() => {
