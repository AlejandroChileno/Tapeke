                    ...
                    <SView col={"xs-12"} center row flex style={{ backgroundColor: STheme.color.primary, borderRadius: 12 }}>
                        ...
                        <SView col={"xs-12"} height={100} row center  >
                            ...
                            <SView flex center height={60} >
                                <SView height={60} colSquare center style={{ backgroundColor: 'white', borderRadius: 8, borderColor: STheme.color.primary, borderWidth: 2, padding: 8 }} onPress={() => { ImgSaveGallery.guardar(this.key_qr); }}>
                                    <SIcon name={"ImgSave"} />
                                </SView>
                            </SView>
                            <SView flex center height={60} >
                                <SView height={60} colSquare center style={{ backgroundColor: 'white', borderRadius: 8, borderColor: STheme.color.primary, borderWidth: 2, padding: 8 }} onPress={() => { ImgShared.compartir(this.key_qr); }}>
                                    <SIcon name={"ImgShare"} />
                                </SView>
                            </SView>
                            <SView col={"xs-2"} height center>
                        ...
                        <SView col={"xs-12"} row center   >
                            <SView col={"xs-11"} border={'transparent'}  >
                                ...
                                <SHr height={30} />
                                 ...
                                 <PButtom secondary props={{ type: "outline" }} onPress={() => { SNavigation.navigate(Parent.component + "/registro") }} >local storage</PButtom>
                                 <SHr height={30} />
