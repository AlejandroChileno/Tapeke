        ...
        <BarraSuperiorTapeke>
          <SView row>
            <SView height={50} width={15} backgroundColor={"transparent"}>
              <SView style={{ top: 6 }} center><SIcon name={"Location"} height={12} fill="#fff" /></SView>
            </SView>
            <SView border={'transparent'} height={50} style={{ justifyContent: "center", paddingLeft: 8, paddingRight: 8 }}>
            ...
            <SView height={50} width={20} backgroundColor={"transparent"}>
              <SView style={{ top: 12 }} center><SIcon name={"Back"} height={12} fill="#fff" style={{ transform: [{ rotate: "-90deg" }] }} /></SView>
            </SView>
          </SView>
        </BarraSuperiorTapeke>

        <SPage title={"Inicio"} hidden disableHorizontal={true}>
