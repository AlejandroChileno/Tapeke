...
class Inicio extends Component {
        ...
        return <SView col={"xs-12"} center style={{
            ...
            <SView width={300} height={155} center>
                <SView col={"xs-12"} height style={{ position: "absolute", }}>
                    <SIcon name={"homeBox"} fill={"#01899233"} width={"100%"} height={"100%"} />
                </SView>
    ...
    getAdministracion() {
        this.usr = usuario.Actions.validateSession(this.props);
    ...
    getContent2() {
        return <SView col={"xs-12"} row center>
            ...
            {this.getButtom({ label: 'Imagenología', url: 'inDevelop', icon: 'simagenologia' })}
