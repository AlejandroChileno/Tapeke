...
class NavBar2 extends React.Component {
	static INSTACE = null;
	static open() {
		NavBar2.INSTACE.fadeIn();
	}
	static close() {
		NavBar2.INSTACE.fadeOut();
	}
	...
	getNav() {
		...
		// todo aqui se cambia el tamaño ancho y largo de la pantalla
		return <SView col={"xs-9 md-6 xl-4"} height={80} backgroundColor={STheme.color.background} center
			style={{
		...
		>
			<SView col={"xs-12"} backgroundColor={"green"} width="100%" height={105} center
...
export default connect(initStates)(NavBar2);