...
class ShowMapa extends Component {
    ...
    render() {
        var dataPedido = conductor_horario.Actions.getPedidoProximoByKey(this.props.state.usuarioReducer.usuarioLog.key, this.props);
        ...
        return <>
            <SView col={"xs-12"} flex>
                ...
                >
                    <SMarker lat={dataPedido?.restaurante["latitude"]} lng={dataPedido?.restaurante["longitude"]}  >
